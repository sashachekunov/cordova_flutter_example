...
import 'package:flutter_module/animation_state_types/bullet_damage.dart';
import 'package:flutter_module/animation_state_types/bullet_interval.dart';
import 'package:flutter_module/animation_state_types/bullet_speed.dart';
...
import 'package:flutter_module/components/bullet.dart';
...
class PlantDefender extends Plant with HasGameRef<PlantsVsInvaders>, CollisionCallbacks {
  ...
  Future<SpriteAnimation> _spriteAnimation(PlantDefenderType plantDefenderType, String action, int amount) async {
    final image = await Flame.images
        .load("levels/plants/defenders/${plantDefenderType.name}/${plantDefenderType.name}_$action.png");
